...
- **[Commerce Systems](./commerce-systems/README.md)** - E-commerce platforms, payment systems, and online retail technologies
- **[Git](./git/README.md)** - Version control, branching strategies, collaboration workflows, and Git best practices
- **[.NET and C#](./dotnet-csharp/README.md)** - .NET ecosystem, C# language, services, breaking changes, best practices, and style guide
- **[Kubernetes](./kubernetes/README.md)** - Container orchestration, cloud-native technologies, and K8s ecosystem
- **[Microservices](./microservices/README.md)** - Microservices architecture, design principles, and best practices
- **[Observability](./observability/README.md)** - Monitoring, logging, tracing, and system observability
